...
namespace CobranzaAPI.Areas.Cobranza.Controllers
{
    public class FacturaController : ApiController
    {
        ...
        public JsonResult<ListaFacturaRespuesta> obtenerFacturas(string Token, string NumeroCliente)
        {
            ...
            respuesta.Facturas.Add(new FacturaEncabezado("EG Transportes", "EPA070313S59", 15000, "2018-09-26 10:19:59"));
            respuesta.Facturas.Add(new FacturaEncabezado("EG Transportes", "EPA070313S59", 18520, "2018-09-20 16:45:15"));
            respuesta.Facturas.Add(new FacturaEncabezado("EG Transportes", "EPA070313S59", 14526, "2018-09-10 09:23:28"));
            #endregion
    ...
    {
        public FacturaEncabezado(string empresa, string rFC, double total, string fechaEmision)
        {
            Empresa = empresa;
            RFC = rFC;
            Total = total;
